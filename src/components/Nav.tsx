...
export default function Nav() {
  ...
  // Escape closes the Services dropdown and the mobile menu
  useEffect(() => {
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-18" style={{ height: '72px' }}>
          ...
          <nav aria-label="Main" className="hidden lg:flex items-center gap-6 xl:gap-9">
            ...
            {/* Services dropdown: opens on hover or click/Enter; closes on Escape (see effect above) or when focus leaves */}
            <div
              className="relative"
