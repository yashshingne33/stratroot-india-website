...
//   { label: 'Export & Trade Consulting', slug: 'export-trade' },
//   { label: 'Financial Strategy', slug: 'financial-strategy' },
//   { label: 'Market Entry & Expansion', slug: 'market-entry' },
//   { label: 'Digital Transformation', slug: 'digital-transformation' },
//   { label: 'HR & Org Design', slug: 'hr-org-design' },
//   { label: 'Supply Chain Optimization', slug: 'supply-chain' },
// ]
...
//   const textColor = scrolled || !isHome ? 'text-[#111827]' : 'text-white'
...
//             <Link
//               to="/about"
//               className={`text-sm font-medium transition-colors hover:text-[#B7791F] ${textColor}`}
//             >
//               About
//             </Link>
...
//             >
//               <button
//                 className={`flex items-center gap-1 text-sm font-medium transition-colors hover:text-[#B7791F] ${textColor}`}
//               >
//                 Services
...
//                   <div className="bg-white border border-[#E2E8F0] rounded-lg shadow-xl p-4 w-72">
//                     <p className="text-[10px] font-semibold tracking-widest uppercase text-[#B7791F] mb-3 px-2">
//                       What We Do
//                     </p>
...
//                           key={s.slug}
//                           to={`/services/${s.slug}`}
//                           className="block px-2 py-2 text-sm text-[#374151] hover:bg-[#F8FAFC] hover:text-[#111827] rounded transition-colors"
//                         >
//                           {s.label}
//                         </Link>
//                       ))}
...
//                       <Link
//                         to="/services"
//                         className="block px-2 py-1.5 text-sm font-medium text-[#B7791F] hover:underline"
//                       >
//                         View All Services →
//                       </Link>
//                     </div>
...
//       {/* Mobile menu */}
//       {open && (
//         <div className="lg:hidden bg-white border-t border-[#E2E8F0] px-6 py-6">
...
//                 key={item.to}
//                 to={item.to}
//                 className="block py-3 text-base font-medium text-[#111827] border-b border-[#F1F5F9] hover:text-[#B7791F] transition-colors"
//               >
//                 {item.label}
//               </Link>
//             ))}
        ...
        <div className="flex items-center justify-between h-18" style={{ height: '72px' }}>
          ...
          <nav className="hidden lg:flex items-center gap-8">
            ...
            >
              ...
              {servicesOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 pt-3">
                  <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg shadow-xl p-4 w-72">
