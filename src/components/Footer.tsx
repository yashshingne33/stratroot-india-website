...
// // Keep the Gmail address until connect@stratroot.com is created and tested,
// // then change this one constant (it is used for both the link and the label).
// const CONTACT_EMAIL = 'stratroot@gmail.com'

// // Insights is left out until its content is ready; add it between Industries and Contact.
// const QUICK_LINKS = [
//   { label: 'About', to: '/about' },
//   { label: 'Services', to: '/services' },
//   { label: 'Export Consulting', to: '/export-consulting' },
...
//             <ul className="space-y-3">
//               <li className="flex items-start gap-2 text-sm min-w-0" style={{ color: 'var(--color-muted)' }}>
//                 <Mail size={14} className="mt-0.5 flex-shrink-0" aria-hidden="true" />
//                 <a href={`mailto:${CONTACT_EMAIL}`} className="break-words transition-colors hover:text-white">
//                   {CONTACT_EMAIL}
//                 </a>
//               </li>
//               <li className="flex items-start gap-2 text-sm min-w-0" style={{ color: 'var(--color-muted)' }}>
